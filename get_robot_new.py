...
class sim_robot_env:
    def __init__(self, use_sim, box_object,startPos1, theta1, startPos2, theta2, box_i):
        ...
        #startPos = [0, 0, 0]
        # startPos2 = [0,0.8,0]
        startOrientation = p.getQuaternionFromEuler([0, 0, theta1])
        startOrientation2 = p.getQuaternionFromEuler([0, 0, theta2])
        ...
        self.robot = p.loadURDF("kuka_iiwa/model.urdf", startPos1, startOrientation, useFixedBase=1)
