...
from path_optimisation_functions import fk_ineq, flux_ineq, dir_ineq, vel_cost, vel_ineq
...
while 1:
    ...
    state = np.concatenate((q_dot_current, slack_1, slack_2))
