...
while (1):
    ...
    robot.draw_point([X0.tolist()], [[1, 0, 0]], 10, 0)
    robot.draw_point([X1.tolist()], [[1, 0, 0]], 10, 0)
    robot.draw_point([X2.tolist()], [[1, 0, 0]], 10, 0)
    robot.draw_point([X3.tolist()], [[1, 0, 0]], 10, 0)
    robot.draw_point([X4.tolist()], [[1, 0, 0]], 10, 0)
    robot.draw_point([X5.tolist()], [[1, 0, 0]], 10, 0)
    robot.draw_point([X6.tolist()], [[1, 0, 0]], 10, 0)

    robot.draw_point([X_0.tolist()], [[0, 1, 0]], 10, 0)
    robot.draw_point([X_1.tolist()], [[0, 1, 0]], 10, 0)
    robot.draw_point([X_2.tolist()], [[0, 1, 0]], 10, 0)
    robot.draw_point([X_3.tolist()], [[0, 1, 0]], 10, 0)
    robot.draw_point([X_4.tolist()], [[0, 1, 0]], 10, 0)
    robot.draw_point([X_5.tolist()], [[0, 1, 0]], 10, 0)
    robot.draw_point([X_6.tolist()], [[0, 1, 0]], 10, 0)
