...
def simulate(X_i_robot, theta_i_robot, X_m_robot, theta_m_robot, h_dir1, p_des1, X_ref1, box_i, h_dir2, p_des2, X_ref2):
    ...
    startPos1 = [X_i_robot[0], X_i_robot[1], 0.0]
    startPos2 = [X_m_robot[0], X_m_robot[1], 0.0]
...
def simulation_parameters(X_opt, Xi, Xf, box1, box2):
    ...
    print("X_m_robot0", X_m_robot0)
    print("X_m_robot", X_m_robot)
...
model_data_paths = ['Data/model_error_full.h5', 'Data/model_error_2d.h5']
...
print('X_i_robot: ', X_i_robot)
print('theta_i_robot: ', theta_i_robot)
print('X_m_robot: ', X_m_robot)
print('theta_m_robot: ', theta_m_robot)
